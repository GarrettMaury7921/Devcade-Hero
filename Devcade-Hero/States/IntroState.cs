...
namespace DevcadeHero.States
{
    ...
    */
    public class IntroState : State
    {
        ...
        private readonly Song guitar_solo_intro;
        ...
        private void PickVideoAndMusic()
        {
            ...
            Random random = new();
            randomValue = random.Next(1, 6); // generates a random value between x and y-1 (inclusive)
            switch (randomValue)
            {
                ...
                // Guitar Solo Intro
                case 4:
                    videoName = "guitar_solo.mp4";
                    songName = guitar_solo_intro;
                    increase_scale = 0.006;
                    State_name = "MenuState1";
            ...
            base(game, graphicsDevice, PreferredBackBufferWidth, PreferredBackBufferHeight, content, _state_name)
        {
            ...
            guitar_solo_intro = _content.Load<Song>("Songs/guitar_solo_intro");
